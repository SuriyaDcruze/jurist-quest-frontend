...
const Overview = ({ overviewData }: OverviewProps) => {
  ...
  const [countdownSubLabel, setCountdownSubLabel] = useState("at 30th September 2025")

  useEffect(() => {
    let targetDate = new Date("2025-09-29T00:00:00");
    let label = "Competition starts in";
    let subLabel = "at 30th September 2025";
